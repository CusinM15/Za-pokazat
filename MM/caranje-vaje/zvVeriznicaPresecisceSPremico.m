function presecisceY = zvVeriznicaPresecisceSPremico(obesisceL,obesisceD,L,tol, premica)
...
presecisceX = fzero(@(x)w(x) - premica(x), 0);
presecisceY = premica(presecisceX);
