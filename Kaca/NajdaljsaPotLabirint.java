...
public class NajdaljsaPotLabirint {
	 ...
	 public static void main(String[] args)
	 {
	  ...
	  List< Celica > pot = najdaljsaPot(labirint);
	  if (pot == null)
	  {
	   System.out.println("Ne obstaja pot");
	   return;
	  }
	  for (Celica celica : pot)
	   System.out.print(celica + ",");
	  System.out.println();
	 }

	 private static List< Celica > najdaljsaPot(boolean[][] labirint)
	 {
	  Celica zacetek = new Celica(0, 0);
	  Celica konec = new Celica(labirint.length - 1, labirint[0].length - 1);
	  List< Celica > pot = najdaljsaPot(labirint, zacetek, konec);
	  return pot;
	 }

	 private static List< Celica > najdaljsaPot(boolean[][] labirint, Celica zacetek,
	   Celica konec)
	 {
